...
create table TAIKHOAN (
	...
	EMAIL		varchar(50),
	DIACHI		nvarchar(255),
	MAQ			int foreign key references NHOMQUYEN(MAQ), ---------------------------
	TRANGTHAI	int
)
...
insert into SANPHAM(MASP, TENSP, HINHANH, GIANHAP, GIABAN, MALOAI, SOLUONG, TRANGTHAI) values
('S00001', 'Đầm tay phồng cổ trụ', 'S00001.jpg', 100000, 200000, '01', 140, 1), 
('S00002', 'Đầm tay ngắn bèo viền ren', 'S00002.jpg', 100000, 300000, '01', 60, 1), 
('S00003', 'Đầm tay ngắn giả túi thanh lịch', 'S00003.jpg', 100000, 250000, '01', 40, 1), 
('S00004', 'Đầm tay ngắn cổ chữ U', 'S00004.jpg', 100000, 300000, '01', 40, 1), 
('S00005', 'Đầm 2 dây nơ', 'S00005.jpg',350000, '01', 30000, 80000, 1),
('S00006', 'Áo thun ngắn tay MESIYOU', 'S00006.jpg', 100000, 180000, '02', 40, 1),
('S00007', 'Quần tây trơn xẻ tà bên sợi', 'S00007.jpg', 100000, 200000, '03', 40, 1), 
('S00008', 'Chân váy ngắn xếp ly xòe', 'S00008.jpg', 100000, 270000, '04', 80, 1); 
